          ...
          <Col>
            <div className="card text-center">
              ...
              <div className="card-body service-info">
                ...
                <p className="text-secondary small">
                  We will give oportunities to see the beautful view of see, We
                  promise you a rememberable journey on the sea Explorations
                </p>
              </div>
            </div>
          </Col>
          <Col>
            <div className="card text-center">
              ...
              <div className="card-body service-info">
                ...
                <p className="text-secondary small">
                  We provide you all the neccessary accomodation you need in our
                  hotel, As we care we provide good quality services
                </p>
              </div>
            </div>
          </Col>
